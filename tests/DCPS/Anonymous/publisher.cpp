...
#include "AnonymousTypeSupportImpl.h"
#include "Writer.h"
#include "Args.h"
...
int ACE_TMAIN(int argc, ACE_TCHAR *argv[])
{
  ...
  try {
    ...
    std::cout << "Starting publisher" << std::endl;
    {
      ...
      append(props, "OpenDDS.RtpsRelay.Groups", "Anonymous", true);
      ...
      // Register TypeSupport (Anonymous::Structure)
      Anonymous::StructureTypeSupport_var mts =
        new Anonymous::StructureTypeSupportImpl();
